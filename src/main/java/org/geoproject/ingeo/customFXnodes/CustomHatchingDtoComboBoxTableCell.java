...
public class CustomHatchingDtoComboBoxTableCell extends TableCell<EgeDto, ComboBox<HatchingDto>> {
    ...
    public CustomHatchingDtoComboBoxTableCell(ObservableList<HatchingDto> dtoObservableList,
    ...
    private ComboBox<HatchingDto> createBox() {
        var box = new ComboBox<HatchingDto>();
