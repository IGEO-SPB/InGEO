...
@Component
public class CompressionDeformationTableController implements Initializable {
    ...
    private void initHeaders() {
        ...
        var headerMpa = new SpreadsheetHeader("Деформация от нагрузки [МПа->мм]", List.of(
    ...
    public CompressionDeformationTableController(ConfigurableApplicationContext applicationContext, CompressionService service, CurrentState state) {
    ...
    private ObservableList<SpreadsheetCell> createDataSpreadsheetRow(CompressionDto dto, int row) {
        ...
        var c1 = createDoubleCell(dto.getItem_00000().deformationProperty(), row, colIter++);
        var c2 = createDoubleCell(dto.getItem_00125().deformationProperty(), row, colIter++);
        var c3 = createDoubleCell(dto.getItem_00250().deformationProperty(), row, colIter++);
        var c4 = createDoubleCell(dto.getItem_00500().deformationProperty(), row, colIter++);
        var c5 = createDoubleCell(dto.getItem_00750().deformationProperty(), row, colIter++);
        var c6 = createDoubleCell(dto.getItem_01000().deformationProperty(), row, colIter++);
        var c7 = createDoubleCell(dto.getItem_02000().deformationProperty(), row, colIter++);
        var c8 = createDoubleCell(dto.getItem_03000().deformationProperty(), row, colIter++);
        var c9 = createDoubleCell(dto.getItem_04000().deformationProperty(), row, colIter++);
        var c10 = createDoubleCell(dto.getItem_05000().deformationProperty(), row, colIter++);
        var c11 = createDoubleCell(dto.getItem_06000().deformationProperty(), row, colIter++);
        var c12 = createDoubleCell(dto.getItem_07000().deformationProperty(), row, colIter++);
        var c13 = createDoubleCell(dto.getItem_08000().deformationProperty(), row, colIter++);
        var c14 = createDoubleCell(dto.getItem_09000().deformationProperty(), row, colIter++);
        var c15 = createDoubleCell(dto.getItem_10000().deformationProperty(), row, colIter++);
