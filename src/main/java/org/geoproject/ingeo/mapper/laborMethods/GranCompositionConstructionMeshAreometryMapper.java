...
public interface GranCompositionConstructionMeshAreometryMapper {
    ...
    ConstructionMeshAreometryResultDto granCompositionConstructionMeshAreometryToConstructionMeshAreometryResultDto(GranCompositionConstructionMeshAreometry source);

    List<ConstructionMeshAreometryResultDto> granCompositionConstructionMeshAreometryToConstructionMeshAreometryResultDto(List<GranCompositionConstructionMeshAreometry> source);

    //    @Override
    default void updateModelFromDto(List<GranCompositionConstructionMeshAreometry> updatedObjects,
                                                                                    List<ConstructionMeshAreometryResultDto> sourceDTOs) {
        for (var updatedObject : updatedObjects) {
            for (var sourceDTO : sourceDTOs) {
                if (Objects.equals(updatedObject.getSample().getLaborNumber(), sourceDTO.getLaborNumber())) {
                    this.updateGranCompositionConstructionMeshAreometryFromConstructionMeshAreometryResultDto(updatedObject, sourceDTO);
                }
            }
        }
    }
...
//    @Mapping(target = "HCl", ignore = true)
    void updateGranCompositionConstructionMeshAreometryFromConstructionMeshAreometryResultDto(@MappingTarget GranCompositionConstructionMeshAreometry updatedObject, ConstructionMeshAreometryResultDto sourceDTO);
...
//    void updateConstructionMeshAreometryFromSample(@MappingTarget ConstructionMeshAreometry updatedObject, Sample updateData);

//    @Override
//    ConstructionMeshAreometry updateTFromY(ConstructionMeshAreometry updatedObject, ConstructionMeshAreometryDTO sourceDTO);

    default void updateGranCompositionConstructionMeshAreometry(@MappingTarget GranCompositionConstructionMeshAreometry updatedGranCompositionConstructionMeshAreometry, Sample updateData) {
        updatedGranCompositionConstructionMeshAreometry.setSample(updateData);
    }
}
