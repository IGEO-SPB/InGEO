...
uses = {WaterExtractMapperQualifier.class})
public interface WaterExtractMapper {

    @Mapping(target = "laborNumber", source = "waterExtractPartial.sample.laborNumber")
    @Mapping(target = "surveyPointNumber", source = "waterExtractPartial.sample.surveyPoint.pointNumber")
    WaterExtractPartialDto waterExtractPartialToWaterExtractPartialDto(WaterExtractPartial waterExtractPartial);

    List<WaterExtractPartialDto> waterExtractPartialToWaterExtractPartialDto(List<WaterExtractPartial> waterExtractPartials);
